...
import MultiTextFields, { MultiTextProps } from './MultiTextFields';

export default {
  component: MultiTextFields,
  title: 'questions/MultiTextFields',
};

export const DefaultView: Story<MultiTextProps> = (Props) => {
  const question = {
...
export const condtionalView: Story<MultiTextProps> = (Props) => {
  const question = {
...
/**
 * According to the https://alphafounders.atlassian.net/browse/MEDIA-237,
 * need to support `phone` and `email` question in multi question in qFlow package
 */
export const PhoneAndEmailFieldsView: Story<MultiTextProps> = (Props) => {
  const question = {
    code: 'phone',
    section: 'loan',
    type: 'multi_question',
